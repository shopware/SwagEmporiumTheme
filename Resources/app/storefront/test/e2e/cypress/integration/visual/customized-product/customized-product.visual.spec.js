...
describe('Customized Product: Check appearance of customized products', () => {
    ...
    it('@visual @customized: Customized product with all options', () => {
        ...
        // Textarea (required);
        cy.contains('.swag-customized-products-option__title', 'Example textarea')
            .should('be.visible')
            .click();
        ...
        cy.contains('.swag-customized-products-option__title', 'Example numberfield').should('be.visible').click();
        ...
        cy.get("a[href='#loginCollapse']").click();
