describe('AmazonPay: Basic view', { tags: ['@workflow'] }, () => {
    beforeEach(() => {
    ...
    it.skip('@AmazonPay: should have an technical required amazon pay cookie', () => {
    ...
    it.skip('@AmazonPay: should see logo in footer', () => {
        cy.get('.js-cookie-configuration-button').click();
