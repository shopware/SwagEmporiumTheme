...
describe('Wishlist: Merge wishlist', { tags: ['@workflow'] }, () => {
    beforeEach(() => {
    ...
    it('@wishlist: can be merge from anonymous user to registered users with same product', () => {
        cy.visit('/');
    ...
    it('@wishlist: can be merge from anonymous user to registered users with different product', () => {
